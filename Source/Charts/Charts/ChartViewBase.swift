...
public protocol ChartViewDelegate
{
    ...
    @objc optional func chartValueLongPressed(_ chartView: ChartViewBase, entry: ChartDataEntry, dataSetIndex: Int, highlight: Highlight)
...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    open func highlightValueForLongTap(_ highlight: Highlight?, callDelegate: Bool) {
