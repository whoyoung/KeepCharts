...
@objc(KeepChartLegendEntry)
open class KeepLegendEntry: NSObject
{
    ...
    /// `Default` will use the KeepLegend's default.
    @objc open var form: KeepLegend.Form = .default
