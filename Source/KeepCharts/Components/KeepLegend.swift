...
open class KeepLegend: KeepComponentBase
{
    ...
    @objc open var entries = [KeepLegendEntry]()
    
    /// Entries that will be appended to the end of the auto calculated entries after calculating the legend.
    /// (if the legend has already been calculated, you will need to call notifyDataSetChanged() to let the changes take effect)
    @objc open var extraEntries = [KeepLegendEntry]()
    ...
    @objc public init(entries: [KeepLegendEntry])
    {
        super.init()
    ...
    @objc open func calculateDimensions(labelFont: NSUIFont, viewPortHandler: KeepViewPortHandler)
    {
    ...
    @objc open func setCustom(entries: [KeepLegendEntry])
    {
        self.entries = entries
