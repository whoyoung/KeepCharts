//
//  KeepScatterChartRenderer.swift
//  Charts
//
...
open class KeepScatterChartRenderer: KeepLineScatterCandleRadarRenderer
{
    @objc open weak var dataProvider: KeepScatterChartDataProvider?
    
    @objc public init(dataProvider: KeepScatterChartDataProvider, animator: KeepAnimator, viewPortHandler: KeepViewPortHandler)
    {
    ...
    open override func drawData(context: CGContext)
    {
        ...
        for i in 0 ..< scatterData.dataSetCount
        {
            ...
            if set.isVisible
            {
                if !(set is KeepIScatterChartDataSet)
                {
                    fatalError("Datasets for KeepScatterChartRenderer must conform to KeepIScatterChartDataSet")
                }
                
                drawDataSet(context: context, dataSet: set as! KeepIScatterChartDataSet)
            }
        }
    }
    ...
    @objc open func drawDataSet(context: CGContext, dataSet: KeepIScatterChartDataSet)
    {
        ...
        {
            print("There's no KeepIShapeRenderer specified for ScatterDataSet", terminator: "\n")
        }
    }
    ...
    open override func drawValues(context: CGContext)
    {
        ...
        {
            guard let dataSets = scatterData.dataSets as? [KeepIScatterChartDataSet] else { return }
    ...
    open override func drawHighlighted(context: CGContext, indices: [KeepHighlight])
    {
        ...
        {
            guard
                let set = scatterData.getDataSetByIndex(high.dataSetIndex) as? KeepIScatterChartDataSet,
