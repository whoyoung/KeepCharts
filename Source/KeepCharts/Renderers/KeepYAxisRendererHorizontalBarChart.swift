//
//  KeepYAxisRendererHorizontalBarChart.swift
//  Charts
//
...
open class KeepYAxisRendererHorizontalBarChart: KeepYAxisRenderer
{
    public override init(viewPortHandler: KeepViewPortHandler, yAxis: KeepYAxis?, transformer: KeepTransformer?)
    {
    ...
    {
        guard let yAxis = axis as? KeepYAxis else { return }
    ...
    {
        guard
            let yAxis = self.axis as? KeepYAxis,
