...
@objc(KeepChartAxisRendererBase)
open class KeepAxisRendererBase: KeepRenderer
{
    ...
    {
        fatalError("renderAxisLabels() cannot be called on KeepAxisRendererBase")
    }
    
    /// Draws the grid lines belonging to the axis.
    @objc open func renderGridLines(context: CGContext)
    {
        fatalError("renderGridLines() cannot be called on KeepAxisRendererBase")
    }
    
    /// Draws the line that goes alongside the axis.
    @objc open func renderAxisLine(context: CGContext)
    {
        fatalError("renderAxisLine() cannot be called on KeepAxisRendererBase")
    }
    
    /// Draws the LimitLines associated with this axis to the screen.
    @objc open func renderLimitLines(context: CGContext)
    {
        fatalError("renderLimitLines() cannot be called on KeepAxisRendererBase")
    }
