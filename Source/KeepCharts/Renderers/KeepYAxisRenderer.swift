...
@objc(KeepChartYAxisRenderer)
open class KeepYAxisRenderer: KeepAxisRendererBase
{
    @objc public init(viewPortHandler: KeepViewPortHandler, yAxis: KeepYAxis?, transformer: KeepTransformer?)
    {
    ...
    {
        guard let yAxis = self.axis as? KeepYAxis else { return }
