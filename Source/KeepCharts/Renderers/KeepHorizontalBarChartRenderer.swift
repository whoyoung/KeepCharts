//
//  KeepHorizontalBarChartRenderer.swift
//  Charts
//
...
open class KeepHorizontalBarChartRenderer: KeepBarChartRenderer
{
    ...
    public override init(dataProvider: KeepBarChartDataProvider, animator: KeepAnimator, viewPortHandler: KeepViewPortHandler)
    {
    ...
    open override func drawDataSet(context: CGContext, dataSet: KeepIBarChartDataSet, index: Int)
    {
    ...
    open override func isDrawingValuesAllowed(dataProvider: KeepChartDataProvider?) -> Bool
    {
    ...
    internal override func setHighlightDrawPos(highlight high: KeepHighlight, barRect: CGRect)
    {
