...
@objc(KeepChartViewPortHandler)
open class KeepViewPortHandler: NSObject
{
    ...
    @objc open func centerViewPort(pt: CGPoint, chart: KeepChartViewBase)
    {
        let translateX = pt.x - offsetLeft
        let translateY = pt.y - offsetTop
    ...
    @objc @discardableResult open func refresh(newMatrix: CGAffineTransform, chart: KeepChartViewBase, invalidate: Bool) -> CGAffineTransform
    {
