...
@objc(KeepChartFill)
open class KeepFill: NSObject
{
    private var _type: KeepFillType = KeepFillType.empty
    ...
    @objc open var type: KeepFillType
    {
        return _type
    }
    ...
    @objc open class func fillWithCGColor(_ CGColor: CGColor) -> KeepFill
    {
        return KeepFill(CGColor: CGColor)
    }
    
    @objc open class func fillWithColor(_ color: NSUIColor) -> KeepFill
    {
        return KeepFill(color: color)
    }
    
    @objc open class func fillWithLinearGradient(
        _ linearGradient: CGGradient,
        angle: CGFloat) -> KeepFill
    {
        return KeepFill(linearGradient: linearGradient, angle: angle)
    }
    ...
    @objc open class func fillWithRadialGradient(_ radialGradient: CGGradient) -> KeepFill
    {
        return KeepFill(radialGradient: radialGradient)
    }
    
    @objc open class func fillWithCGImage(_ CGImage: CGImage, tiled: Bool) -> KeepFill
    {
        return KeepFill(CGImage: CGImage, tiled: tiled)
    }
    
    @objc open class func fillWithImage(_ image: NSUIImage, tiled: Bool) -> KeepFill
    {
        return KeepFill(image: image, tiled: tiled)
    }
    
    @objc open class func fillWithCGImage(_ CGImage: CGImage) -> KeepFill
    {
        return KeepFill(CGImage: CGImage)
    }
    
    @objc open class func fillWithImage(_ image: NSUIImage) -> KeepFill
    {
        return KeepFill(image: image)
    }
    
    @objc open class func fillWithCGLayer(_ CGLayer: CGLayer) -> KeepFill
    {
        return KeepFill(CGLayer: CGLayer)
    }
