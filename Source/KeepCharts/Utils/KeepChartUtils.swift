...
open class KeepChartUtils
{
    private static var _defaultValueFormatter: KeepIValueFormatter = KeepChartUtils.generateDefaultValueFormatter()
    ...
    private class func generateDefaultValueFormatter() -> KeepIValueFormatter
    {
        let formatter = KeepDefaultValueFormatter(decimals: 1)
        return formatter
    }
    
    /// - returns: The default value formatter used for all chart components that needs a default
    open class func defaultValueFormatter() -> KeepIValueFormatter
    {
