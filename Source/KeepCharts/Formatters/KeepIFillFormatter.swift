...
@objc(KeepIChartFillFormatter)
public protocol KeepIFillFormatter
{
    /// - returns: The vertical (y-axis) position where the filled-line of the LineDataSet should end.
    func getFillLinePosition(dataSet: KeepILineChartDataSet, dataProvider: KeepLineChartDataProvider) -> CGFloat
}
