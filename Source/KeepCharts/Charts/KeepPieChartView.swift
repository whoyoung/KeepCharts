...
open class KeepPieChartView: KeepPieRadarChartViewBase
{
    ...
    internal override func initialize()
    {
        ...
        renderer = KeepPieChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        _xAxis = nil
        
        self.highlighter = KeepPieHighlighter(chart: self)
    }
    ...
    internal override func calculateOffsets()
    {
        ...
        let shift = (data as? KeepPieChartData)?.dataSet?.selectionShift ?? 0.0
    ...
    private func calcAngles()
    {
        ...
        let yValueSum = (_data as! KeepPieChartData).yValueSum
    ...
    {
        return calcAngle(value: value, yValueSum: (_data as! KeepPieChartData).yValueSum)
    }
    ...
    /// This will throw an exception, PieChart has no KeepXAxis object.
    open override var xAxis: KeepXAxis
    {
        fatalError("PieChart has no KeepXAxis")
    }
