...
open class KeepRadarChartView: KeepPieRadarChartViewBase
{
    ...
    private var _yAxis: KeepYAxis!
    
    internal var _yAxisRenderer: KeepYAxisRendererRadarChart!
    internal var _xAxisRenderer: KeepXAxisRendererRadarChart!
    ...
    internal override func initialize()
    {
        ...
        _yAxis = KeepYAxis(position: .left)
        
        renderer = KeepRadarChartRenderer(chart: self, animator: _animator, viewPortHandler: _viewPortHandler)
        
        _yAxisRenderer = KeepYAxisRendererRadarChart(viewPortHandler: _viewPortHandler, yAxis: _yAxis, chart: self)
        _xAxisRenderer = KeepXAxisRendererRadarChart(viewPortHandler: _viewPortHandler, xAxis: _xAxis, chart: self)
        
        self.highlighter = KeepRadarHighlighter(chart: self)
    }
