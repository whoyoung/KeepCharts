//
//  KeepPieRadarChartViewBase.swift
//  Charts
//
...
/// Base class of KeepPieChartView and KeepRadarChartView.
open class KeepPieRadarChartViewBase: KeepChartViewBase
{
    ...
    {
        fatalError("indexForAngle() cannot be called on KeepPieRadarChartViewBase")
    }
    ...
    {
        fatalError("radius cannot be called on KeepPieRadarChartViewBase")
    }

    /// - returns: The required offset for the chart legend.
    internal var requiredLegendOffset: CGFloat
    {
        fatalError("requiredLegendOffset cannot be called on KeepPieRadarChartViewBase")
    }
    ...
    {
        fatalError("requiredBaseOffset cannot be called on KeepPieRadarChartViewBase")
    }
    ...
    internal final func processRotationGestureEnded(location: CGPoint)
    {
        if isDragDecelerationEnabled
        {
            ...
            if _decelerationAngularVelocity != 0.0
            {
                ...
                _decelerationDisplayLink = NSUIDisplayLink(target: self, selector: #selector(KeepPieRadarChartViewBase.decelerationLoop))
    ...
    private var _lastHighlight: KeepHighlight!
