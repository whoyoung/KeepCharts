...
open class KeepChartBaseDataSet: NSObject, KeepIChartDataSet
{
    ...
    {
        fatalError("calcMinMax is not implemented in KeepChartBaseDataSet")
    }
    
    open func calcMinMaxY(fromX: Double, toX: Double)
    {
        fatalError("calcMinMaxY(fromX:, toX:) is not implemented in KeepChartBaseDataSet")
    }
    
    open var yMin: Double
    {
        fatalError("yMin is not implemented in KeepChartBaseDataSet")
    }
    
    open var yMax: Double
    {
        fatalError("yMax is not implemented in KeepChartBaseDataSet")
    }
    
    open var xMin: Double
    {
        fatalError("xMin is not implemented in KeepChartBaseDataSet")
    }
    
    open var xMax: Double
    {
        fatalError("xMax is not implemented in KeepChartBaseDataSet")
    }
    
    open var entryCount: Int
    {
        fatalError("entryCount is not implemented in KeepChartBaseDataSet")
    }
        
    open func entryForIndex(_ i: Int) -> KeepChartDataEntry?
    {
        fatalError("entryForIndex is not implemented in KeepChartBaseDataSet")
    }
    
    open func entryForXValue(
        _ x: Double,
        closestToY y: Double,
        rounding: KeepChartDataSetRounding) -> KeepChartDataEntry?
    {
        fatalError("entryForXValue(x, closestToY, rounding) is not implemented in KeepChartBaseDataSet")
    }
    
    open func entryForXValue(
        _ x: Double,
        closestToY y: Double) -> KeepChartDataEntry?
    {
        fatalError("entryForXValue(x, closestToY) is not implemented in KeepChartBaseDataSet")
    }
    
    open func entriesForXValue(_ x: Double) -> [KeepChartDataEntry]
    {
        fatalError("entriesForXValue is not implemented in KeepChartBaseDataSet")
    }
    
    open func entryIndex(
        x xValue: Double,
        closestToY y: Double,
        rounding: KeepChartDataSetRounding) -> Int
    {
        fatalError("entryIndex(x, closestToY, rounding) is not implemented in KeepChartBaseDataSet")
    }
    
    open func entryIndex(entry e: KeepChartDataEntry) -> Int
    {
        fatalError("entryIndex(entry) is not implemented in KeepChartBaseDataSet")
    }
    
    open func addEntry(_ e: KeepChartDataEntry) -> Bool
    {
        fatalError("addEntry is not implemented in KeepChartBaseDataSet")
    }
    
    open func addEntryOrdered(_ e: KeepChartDataEntry) -> Bool
    {
        fatalError("addEntryOrdered is not implemented in KeepChartBaseDataSet")
    }
    
    @discardableResult open func removeEntry(_ entry: KeepChartDataEntry) -> Bool
    {
        fatalError("removeEntry is not implemented in KeepChartBaseDataSet")
    }
    ...
    open func contains(_ e: KeepChartDataEntry) -> Bool
    {
        fatalError("removeEntry is not implemented in KeepChartBaseDataSet")
    }
    ...
    open func clear()
    {
        fatalError("clear is not implemented in KeepChartBaseDataSet")
    }
    ...
    internal var _valueFormatter: KeepIValueFormatter?
    
    /// Custom formatter that is used instead of the auto-formatter if set
    open var valueFormatter: KeepIValueFormatter?
    {
        get
        {
            if needsFormatter
            {
                return KeepChartUtils.defaultValueFormatter()
            }
    ...
    open var form = KeepLegend.Form.default
