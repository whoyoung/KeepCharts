...
open class KeepChartDataEntry: KeepChartDataEntryBase
{
    /// the x value
...
// MARK: Equatable
extension KeepChartDataEntry/*: Equatable*/ {
    open override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? KeepChartDataEntry else { return false }
