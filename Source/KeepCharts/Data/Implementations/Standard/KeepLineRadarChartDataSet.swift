//
//  KeepLineRadarChartDataSet.swift
//  Charts
//
...
open class KeepLineRadarChartDataSet: KeepLineScatterCandleRadarChartDataSet, KeepILineRadarChartDataSet
{
    ...
    {
        let copy = super.copyWithZone(zone) as! KeepLineRadarChartDataSet
