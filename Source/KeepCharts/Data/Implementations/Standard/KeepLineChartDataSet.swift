...
open class KeepLineChartDataSet: KeepLineRadarChartDataSet, KeepILineChartDataSet
{
    ...
    private var _fillFormatter: KeepIFillFormatter = KeepDefaultFillFormatter()
    
    /// Sets a custom KeepIFillFormatter to the chart that handles the position of the filled-line for each DataSet. Set this to null to use the default logic.
    open var fillFormatter: KeepIFillFormatter?
    {
        get
        {
        ...
        set
        {
            _fillFormatter = newValue ?? KeepDefaultFillFormatter()
        }
    }
    ...
    {
        let copy = super.copyWithZone(zone) as! KeepLineChartDataSet
