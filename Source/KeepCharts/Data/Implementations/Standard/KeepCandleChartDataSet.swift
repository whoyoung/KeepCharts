...
open class KeepCandleChartDataSet: KeepLineScatterCandleRadarChartDataSet, KeepICandleChartDataSet
{
    ...
    {
        guard let e = e as? KeepCandleChartDataEntry
            else { return }
    ...
    open override func calcMinMaxY(entry e: KeepChartDataEntry)
    {
        guard let e = e as? KeepCandleChartDataEntry
            else { return }
