//
//  KeepLineScatterCandleRadarChartDataSet.swift
//  Charts
//
...
open class KeepLineScatterCandleRadarChartDataSet: KeepBarLineScatterCandleBubbleChartDataSet, KeepILineScatterCandleRadarChartDataSet
{
    ...
    {
        let copy = super.copyWithZone(zone) as! KeepLineScatterCandleRadarChartDataSet
