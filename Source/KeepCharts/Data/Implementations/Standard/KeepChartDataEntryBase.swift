...
open class KeepChartDataEntryBase: NSObject
{
    /// the y value
...
// MARK: Equatable
extension KeepChartDataEntryBase/*: Equatable*/ {
    open override func isEqual(_ object: Any?) -> Bool {
        guard let object = object as? KeepChartDataEntryBase else { return false }
