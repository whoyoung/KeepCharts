//
//  KeepIScatterChartDataSet.swift
//  Charts
//
...
@objc
public protocol KeepIScatterChartDataSet: KeepILineScatterCandleRadarChartDataSet
{
    ...
    /// - returns: The KeepIShapeRenderer responsible for rendering this DataSet.
    var shapeRenderer: KeepIShapeRenderer? { get }
}
