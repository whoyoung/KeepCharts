...
@objc
public protocol KeepILineChartDataSet: KeepILineRadarChartDataSet
{
    ...
    ///
    /// **default**: Linear
    var mode: KeepLineChartDataSet.Mode { get set }
    ...
    var fillFormatter: KeepIFillFormatter? { get set }
}
