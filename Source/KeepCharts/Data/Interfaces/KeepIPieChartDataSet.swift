...
@objc
public protocol KeepIPieChartDataSet: KeepIChartDataSet
{
    ...
    var xValuePosition: KeepPieChartDataSet.ValuePosition { get set }
    var yValuePosition: KeepPieChartDataSet.ValuePosition { get set }
