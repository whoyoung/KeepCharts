...
@objc
public protocol KeepIChartDataSet
{
    ...
    func entryForIndex(_ i: Int) -> KeepChartDataEntry?
    ...
    func entriesForXValue(_ xValue: Double) -> [KeepChartDataEntry]
    ...
    func entryIndex(entry e: KeepChartDataEntry) -> Int
    ...
    func addEntry(_ e: KeepChartDataEntry) -> Bool
    ...
    /// - parameter e: the entry to add
    /// - returns: `true` if the entry was added successfully, `false` ifthis feature is not supported
    func addEntryOrdered(_ e: KeepChartDataEntry) -> Bool
    ...
    func removeEntry(_ entry: KeepChartDataEntry) -> Bool
    ...
    func contains(_ e: KeepChartDataEntry) -> Bool
    ...
    var valueFormatter: KeepIValueFormatter? { get set }
