...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KeepCharts",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class KeepChartViewPortHandler;
@class KeepChartTransformer;
@class KeepChartViewBase;

SWIFT_CLASS_NAMED("KeepViewPortJob")
@interface KeepChartViewPortJob : NSObject
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xValue:(double)xValue yValue:(double)yValue transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view OBJC_DESIGNATED_INITIALIZER;
- (void)doJob;
...
SWIFT_CLASS("_TtC10KeepCharts23KeepAnimatedViewPortJob")
@interface KeepAnimatedViewPortJob : KeepChartViewPortJob
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xValue:(double)xValue yValue:(double)yValue transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view xOrigin:(CGFloat)xOrigin yOrigin:(CGFloat)yOrigin duration:(NSTimeInterval)duration easing:(double (^ _Nullable)(NSTimeInterval, NSTimeInterval))easing OBJC_DESIGNATED_INITIALIZER;
- (void)doJob;
- (void)start;
...
SWIFT_CLASS("_TtC10KeepCharts23KeepAnimatedMoveViewJob")
@interface KeepAnimatedMoveViewJob : KeepAnimatedViewPortJob
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xValue:(double)xValue yValue:(double)yValue transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view xOrigin:(CGFloat)xOrigin yOrigin:(CGFloat)yOrigin duration:(NSTimeInterval)duration easing:(double (^ _Nullable)(NSTimeInterval, NSTimeInterval))easing OBJC_DESIGNATED_INITIALIZER;
@end


@class KeepChartYAxis;

SWIFT_CLASS("_TtC10KeepCharts23KeepAnimatedZoomViewJob")
@interface KeepAnimatedZoomViewJob : KeepAnimatedViewPortJob
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view yAxis:(KeepChartYAxis * _Nonnull)yAxis xAxisRange:(double)xAxisRange scaleX:(CGFloat)scaleX scaleY:(CGFloat)scaleY xOrigin:(CGFloat)xOrigin yOrigin:(CGFloat)yOrigin zoomCenterX:(CGFloat)zoomCenterX zoomCenterY:(CGFloat)zoomCenterY zoomOriginX:(CGFloat)zoomOriginX zoomOriginY:(CGFloat)zoomOriginY duration:(NSTimeInterval)duration easing:(double (^ _Nullable)(NSTimeInterval, NSTimeInterval))easing OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xValue:(double)xValue yValue:(double)yValue transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view xOrigin:(CGFloat)xOrigin yOrigin:(CGFloat)yOrigin duration:(NSTimeInterval)duration easing:(double (^ _Nullable)(NSTimeInterval, NSTimeInterval))easing SWIFT_UNAVAILABLE;
@end

@protocol KeepChartAnimatorDelegate;
enum KeepChartEasingOption : NSInteger;

SWIFT_CLASS_NAMED("KeepAnimator")
@interface KeepChartAnimator : NSObject
@property (nonatomic, weak) id <KeepChartAnimatorDelegate> _Nullable delegate;
...
///
- (void)animateWithXAxisDuration:(NSTimeInterval)xAxisDuration yAxisDuration:(NSTimeInterval)yAxisDuration easingOptionX:(enum KeepChartEasingOption)easingOptionX easingOptionY:(enum KeepChartEasingOption)easingOptionY;
/// Animates the drawing / rendering of the chart on both x- and y-axis with the specified animation time.
/// If <code>animate(...)</code> is called, no further calling of <code>invalidate()</code> is necessary to refresh the chart.
/// \param xAxisDuration duration for animating the x axis
///
...
///
- (void)animateWithXAxisDuration:(NSTimeInterval)xAxisDuration yAxisDuration:(NSTimeInterval)yAxisDuration easingOption:(enum KeepChartEasingOption)easingOption;
...
/// \param easingOption the easing function for the animation
///
- (void)animateWithXAxisDuration:(NSTimeInterval)xAxisDuration easingOption:(enum KeepChartEasingOption)easingOption;
...
/// \param easingOption the easing function for the animation
///
- (void)animateWithYAxisDuration:(NSTimeInterval)yAxisDuration easingOption:(enum KeepChartEasingOption)easingOption;
@end


SWIFT_PROTOCOL_NAMED("KeepAnimatorDelegate")
@protocol KeepChartAnimatorDelegate
/// Called when the KeepAnimator has stepped.
- (void)animatorUpdated:(KeepChartAnimator * _Nonnull)animator;
/// Called when the KeepAnimator has stopped.
- (void)animatorStopped:(KeepChartAnimator * _Nonnull)animator;
@end


/// This class encapsulates everything both Axis, KeepLegend and LimitLines have in common
SWIFT_CLASS_NAMED("KeepComponentBase")
@interface KeepChartComponentBase : NSObject
...
@class KeepChartLimitLine;

/// Base class for all axes
SWIFT_CLASS_NAMED("KeepAxisBase")
@interface KeepChartAxisBase : KeepChartComponentBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) id <KeepIChartAxisValueFormatter> _Nullable valueFormatter;
...
- (void)addLimitLine:(KeepChartLimitLine * _Nonnull)line;
/// Removes the specified KeepChartLimitLine from the axis.
- (void)removeLimitLine:(KeepChartLimitLine * _Nonnull)line;
/// Removes all LimitLines from the axis.
- (void)removeAllLimitLines;
///
/// returns:
/// The LimitLines of this axis.
@property (nonatomic, readonly, copy) NSArray<KeepChartLimitLine *> * _Nonnull limitLines;
...
SWIFT_CLASS_NAMED("KeepRenderer")
@interface KeepChartRenderer : NSObject
/// the component that handles the drawing area of the chart and it’s offsets
@property (nonatomic, readonly, strong) KeepChartViewPortHandler * _Nonnull viewPortHandler;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS_NAMED("KeepAxisRendererBase")
@interface KeepChartAxisRendererBase : KeepChartRenderer
/// base axis this axis renderer works with
@property (nonatomic, strong) KeepChartAxisBase * _Nullable axis;
/// transformer to transform values to screen pixels and return
@property (nonatomic, strong) KeepChartTransformer * _Nullable transformer;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler transformer:(KeepChartTransformer * _Nullable)transformer axis:(KeepChartAxisBase * _Nullable)axis OBJC_DESIGNATED_INITIALIZER;
...
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC10KeepCharts13KeepChartData")
@interface KeepChartData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSet:(id <KeepIChartDataSet> _Nullable)dataSet;
...
///
/// returns:
/// All DataSet objects this KeepChartData object holds.
@property (nonatomic, copy) NSArray<id <KeepIChartDataSet>> * _Nonnull dataSets;
...
- (KeepChartDataEntry * _Nullable)entryForHighlight:(KeepChartHighlight * _Nonnull)highlight SWIFT_WARN_UNUSED_RESULT;
...
- (id <KeepIChartDataSet> _Nullable)getDataSetByLabel:(NSString * _Nonnull)label ignorecase:(BOOL)ignorecase SWIFT_WARN_UNUSED_RESULT;
- (id <KeepIChartDataSet> _Null_unspecified)getDataSetByIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (void)addDataSet:(id <KeepIChartDataSet> _Null_unspecified)dataSet;
/// Removes the given DataSet from this data object.
/// Also recalculates all minimum and maximum values.
///
/// returns:
/// <code>true</code> if a DataSet was removed, <code>false</code> ifno DataSet could be removed.
- (BOOL)removeDataSet:(id <KeepIChartDataSet> _Null_unspecified)dataSet;
...
- (void)addEntry:(KeepChartDataEntry * _Nonnull)e dataSetIndex:(NSInteger)dataSetIndex;
/// Removes the given Entry object from the DataSet at the specified index.
- (BOOL)removeEntry:(KeepChartDataEntry * _Nonnull)entry dataSetIndex:(NSInteger)dataSetIndex;
...
- (id <KeepIChartDataSet> _Nullable)getDataSetForEntry:(KeepChartDataEntry * _Null_unspecified)e SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// The index of the provided DataSet in the DataSet array of this data object, or -1 if it does not exist.
- (NSInteger)indexOfDataSet:(id <KeepIChartDataSet> _Nonnull)dataSet SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
- (id <KeepIChartDataSet> _Nullable)getFirstLeftWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nonnull)dataSets SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
- (id <KeepIChartDataSet> _Nullable)getFirstRightWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nonnull)dataSets SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
- (void)setValueFormatter:(id <KeepIChartValueFormatter> _Nullable)formatter;
...
- (BOOL)containsWithDataSet:(id <KeepIChartDataSet> _Nonnull)dataSet SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
@property (nonatomic, readonly, strong) id <KeepIChartDataSet> _Nullable maxEntryCountSet;
@end


SWIFT_CLASS("_TtC10KeepCharts39KeepBarLineScatterCandleBubbleChartData")
@interface KeepBarLineScatterCandleBubbleChartData : KeepChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts16KeepBarChartData")
@interface KeepBarChartData : KeepBarLineScatterCandleBubbleChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10KeepCharts22KeepChartDataEntryBase")
@interface KeepChartDataEntryBase : NSObject
/// the y value
...
SWIFT_CLASS("_TtC10KeepCharts18KeepChartDataEntry")
@interface KeepChartDataEntry : KeepChartDataEntryBase
/// the x value
...
@class KeepChartRange;

SWIFT_CLASS("_TtC10KeepCharts21KeepBarChartDataEntry")
@interface KeepBarChartDataEntry : KeepChartDataEntry
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, copy) NSArray<KeepChartRange *> * _Nullable ranges;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP10KeepCharts21KeepChartDataProvider_")
@protocol KeepChartDataProvider
///
/// returns:
...
@property (nonatomic, readonly, strong) KeepChartData * _Nullable data;
...
SWIFT_PROTOCOL("_TtP10KeepCharts24KeepBarChartDataProvider_")
@protocol KeepBarChartDataProvider <KeepBarLineScatterCandleBubbleChartDataProvider>
...
enum KeepChartDataSetRounding : NSInteger;
enum KeepChartLegendForm : NSInteger;

SWIFT_PROTOCOL("_TtP10KeepCharts17KeepIChartDataSet_")
@protocol KeepIChartDataSet
...
- (KeepChartDataEntry * _Nullable)entryForIndex:(NSInteger)i SWIFT_WARN_UNUSED_RESULT;
...
- (KeepChartDataEntry * _Nullable)entryForXValue:(double)xValue closestToY:(double)yValue rounding:(enum KeepChartDataSetRounding)rounding SWIFT_WARN_UNUSED_RESULT;
/// \param xValue the x-value
///
/// \param closestToY If there are multiple y-values for the specified x-value,
///
...
/// nil if no Entry object at that x-value.
- (KeepChartDataEntry * _Nullable)entryForXValue:(double)xValue closestToY:(double)yValue SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// All Entry objects found at the given x-value with binary search.
/// An empty array if no Entry object at that x-value.
- (NSArray<KeepChartDataEntry *> * _Nonnull)entriesForXValue:(double)xValue SWIFT_WARN_UNUSED_RESULT;
...
- (NSInteger)entryIndexWithX:(double)xValue closestToY:(double)yValue rounding:(enum KeepChartDataSetRounding)rounding SWIFT_WARN_UNUSED_RESULT;
/// \param e the entry to search for
///
///
/// returns:
/// The array-index of the specified entry
- (NSInteger)entryIndexWithEntry:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)addEntry:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
/// Adds an Entry to the DataSet dynamically.
...
/// returns:
/// <code>true</code> if the entry was added successfully, <code>false</code> ifthis feature is not supported
- (BOOL)addEntryOrdered:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)removeEntry:(KeepChartDataEntry * _Nonnull)entry SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)contains:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, strong) id <KeepIChartValueFormatter> _Nullable valueFormatter;
///
/// returns:
...
@property (nonatomic, readonly) enum KeepChartLegendForm form;
...
SWIFT_PROTOCOL("_TtP10KeepCharts43KeepIBarLineScatterCandleBubbleChartDataSet_")
@protocol KeepIBarLineScatterCandleBubbleChartDataSet <KeepIChartDataSet>
...
SWIFT_PROTOCOL("_TtP10KeepCharts20KeepIBarChartDataSet_")
@protocol KeepIBarChartDataSet <KeepIBarLineScatterCandleBubbleChartDataSet>
///
/// returns:
...
SWIFT_CLASS("_TtC10KeepCharts20KeepChartBaseDataSet")
@interface KeepChartBaseDataSet : NSObject <KeepIChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly) NSInteger entryCount;
- (KeepChartDataEntry * _Nullable)entryForIndex:(NSInteger)i SWIFT_WARN_UNUSED_RESULT;
- (KeepChartDataEntry * _Nullable)entryForXValue:(double)x closestToY:(double)y rounding:(enum KeepChartDataSetRounding)rounding SWIFT_WARN_UNUSED_RESULT;
- (KeepChartDataEntry * _Nullable)entryForXValue:(double)x closestToY:(double)y SWIFT_WARN_UNUSED_RESULT;
- (NSArray<KeepChartDataEntry *> * _Nonnull)entriesForXValue:(double)x SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)entryIndexWithX:(double)xValue closestToY:(double)y rounding:(enum KeepChartDataSetRounding)rounding SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)entryIndexWithEntry:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
- (BOOL)addEntry:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
- (BOOL)addEntryOrdered:(KeepChartDataEntry * _Nonnull)e SWIFT_WARN_UNUSED_RESULT;
- (BOOL)removeEntry:(KeepChartDataEntry * _Nonnull)entry;
...
@property (nonatomic, strong) UIFont * _Nonnull valueFont;
/// The form to draw for this dataset in the legend.
@property (nonatomic) enum KeepChartLegendForm form;
/// The form size to draw for this dataset in the legend.
/// Return <code>NaN</code> to use the default legend form size.
...
SWIFT_CLASS("_TtC10KeepCharts16KeepChartDataSet")
@interface KeepChartDataSet : KeepChartBaseDataSet
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values;
/// <ul>
///   <li>
///   </li>
/// </ul>
...
@property (nonatomic, copy) NSArray<KeepChartDataEntry *> * _Nonnull values;
- (void)calcMinMax;
- (void)calcMinMaxYFromX:(double)fromX toX:(double)toX;
- (void)calcMinMaxXWithEntry:(KeepChartDataEntry * _Nonnull)e;
- (void)calcMinMaxYWithEntry:(KeepChartDataEntry * _Nonnull)e;
///
/// returns:
/// The minimum y-value this DataSet holds
@property (nonatomic, readonly) double yMin;
...
SWIFT_CLASS("_TtC10KeepCharts42KeepBarLineScatterCandleBubbleChartDataSet")
@interface KeepBarLineScatterCandleBubbleChartDataSet : KeepChartDataSet <KeepIBarLineScatterCandleBubbleChartDataSet>
@property (nonatomic, strong) UIColor * _Nonnull highlightColor;
@property (nonatomic) CGFloat highlightLineWidth;
@property (nonatomic) CGFloat highlightLineDashPhase;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable highlightLineDashLengths;
...
SWIFT_CLASS("_TtC10KeepCharts19KeepBarChartDataSet")
@interface KeepBarChartDataSet : KeepBarLineScatterCandleBubbleChartDataSet <KeepIBarChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
///
/// returns:
...
SWIFT_CLASS_NAMED("KeepDataRenderer")
@interface KeepChartDataRendererBase : KeepChartRenderer
@property (nonatomic, readonly, strong) KeepChartAnimator * _Nonnull animator;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
...
- (BOOL)isDrawingValuesAllowedWithDataProvider:(id <KeepChartDataProvider> _Nullable)dataProvider SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS_NAMED("KeepBarLineScatterCandleBubbleRenderer")
@interface KeepBarLineScatterCandleBubbleChartRenderer : KeepChartDataRendererBase
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts20KeepBarChartRenderer")
@interface KeepBarChartRenderer : KeepBarLineScatterCandleBubbleChartRenderer
@property (nonatomic, weak) id <KeepBarChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <KeepBarChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)initBuffers SWIFT_METHOD_FAMILY(none);
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIBarChartDataSet> _Nonnull)dataSet index:(NSInteger)index;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
...
SWIFT_CLASS("_TtC10KeepCharts8NSUIView")
...
SWIFT_CLASS("_TtC10KeepCharts17KeepChartViewBase")
@interface KeepChartViewBase : NSUIView <KeepChartAnimatorDelegate, KeepChartDataProvider>
///
/// returns:
...
/// labels)
@property (nonatomic, readonly, strong) KeepChartXAxis * _Nonnull xAxis;
...
@property (nonatomic, strong) KeepChartDescription * _Nullable chartDescription;
/// delegate to receive chart events
@property (nonatomic, weak) id <KeepChartViewDelegate> _Nullable delegate;
...
@property (nonatomic, strong) KeepChartDataRendererBase * _Nullable renderer;
@property (nonatomic, strong) id <KeepIChartHighlighter> _Nullable highlighter;
...
@property (nonatomic, strong) id <KeepIChartMarker> _Nullable marker;
...
@property (nonatomic, strong) KeepChartData * _Nullable data;
...
@property (nonatomic, readonly, copy) NSArray<KeepChartHighlight *> * _Nonnull highlighted;
...
- (void)highlightValues:(NSArray<KeepChartHighlight *> * _Nullable)highs;
...
///
/// \param dataIndex The data index to search in (only used in KeepCombinedChartView currently)
///
...
///
- (void)highlightValue:(KeepChartHighlight * _Nullable)highlight;
/// KeepHighlights the value selected by touch gesture.
- (void)highlightValue:(KeepChartHighlight * _Nullable)highlight callDelegate:(BOOL)callDelegate;
///
/// returns:
/// The KeepHighlight object (contains x-index and DataSet index) of the
/// selected value at the given touch point inside the Line-, Scatter-, or
/// CandleStick-Chart.
- (KeepChartHighlight * _Nullable)getHighlightByTouchPoint:(CGPoint)pt SWIFT_WARN_UNUSED_RESULT;
/// The last value that was highlighted via touch.
@property (nonatomic, strong) KeepChartHighlight * _Nullable lastHighlighted;
///
/// returns:
/// The actual position in pixels of the KeepMarkerView for the given Entry in the given DataSet.
...
@property (nonatomic, readonly, strong) KeepChartAnimator * _Null_unspecified chartAnimator;
/// Animates the drawing / rendering of the chart on both x- and y-axis with the specified animation time.
/// If <code>animate(...)</code> is called, no further calling of <code>invalidate()</code> is necessary to refresh the chart.
/// \param xAxisDuration duration for animating the x axis
///
...
///
/// returns:
/// The KeepLegend object of the chart. This method can be used to get an instance of the legend in order to customize the automatically generated KeepLegend.
@property (nonatomic, readonly, strong) KeepChartLegend * _Nonnull legend;
///
/// returns:
/// The renderer object responsible for rendering / drawing the KeepLegend.
@property (nonatomic, readonly, strong) KeepChartLegendRenderer * _Null_unspecified legendRenderer;
///
/// returns:
...
///
/// returns:
/// The KeepViewPortHandler of the chart that is responsible for the
/// content area of the chart and its offsets and dimensions.
@property (nonatomic, readonly, strong) KeepChartViewPortHandler * _Null_unspecified viewPortHandler;
///
/// returns:
...
- (void)removeViewportJob:(KeepChartViewPortJob * _Nonnull)job;
- (void)clearAllViewportJobs;
- (void)addViewportJob:(KeepChartViewPortJob * _Nonnull)job;
/// <em>default</em>: true
///
/// returns:
...
@property (nonatomic, readonly) NSInteger maxVisibleCount;
- (void)animatorUpdated:(KeepChartAnimator * _Nonnull)chartAnimator;
- (void)animatorStopped:(KeepChartAnimator * _Nonnull)chartAnimator;
- (void)nsuiTouchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)nsuiTouchesCancelled:(NSSet<UITouch *> * _Nullable)touches withEvent:(UIEvent * _Nullable)event;
...
@class KeepChartYAxisRenderer;
@class KeepChartXAxisRenderer;
@class UIGestureRecognizer;

/// Base-class of LineChart, BarChart, ScatterChart and CandleStickChart.
SWIFT_CLASS("_TtC10KeepCharts24KeepBarLineChartViewBase")
@interface KeepBarLineChartViewBase : KeepChartViewBase <KeepBarLineScatterCandleBubbleChartDataProvider, UIGestureRecognizerDelegate>
...
/// top axis.
@property (nonatomic, readonly, strong) KeepChartYAxis * _Nonnull leftAxis;
/// The right y-axis object. In the horizontal bar-chart, this is the
/// bottom axis.
@property (nonatomic, readonly, strong) KeepChartYAxis * _Nonnull rightAxis;
/// The left Y axis renderer. This is a read-write property so you can set your own custom renderer here.
/// <em>default</em>: An instance of KeepYAxisRenderer
@property (nonatomic, strong) KeepChartYAxisRenderer * _Nonnull leftYAxisRenderer;
/// The right Y axis renderer. This is a read-write property so you can set your own custom renderer here.
/// <em>default</em>: An instance of KeepYAxisRenderer
@property (nonatomic, strong) KeepChartYAxisRenderer * _Nonnull rightYAxisRenderer;
/// The X axis renderer. This is a read-write property so you can set your own custom renderer here.
/// <em>default</em>: An instance of KeepXAxisRenderer
@property (nonatomic, strong) KeepChartXAxisRenderer * _Nonnull xAxisRenderer;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
- (void)drawRect:(CGRect)rect;
...
- (KeepChartDataEntry * _Null_unspecified)getEntryByTouchPointWithPoint:(CGPoint)pt SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// The DataSet object displayed at the touched position of the chart
- (id <KeepIBarLineScatterCandleBubbleChartDataSet> _Nullable)getDataSetByTouchPointWithPoint:(CGPoint)pt SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
SWIFT_CLASS("_TtC10KeepCharts19KeepBubbleChartData")
@interface KeepBubbleChartData : KeepBarLineScatterCandleBubbleChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10KeepCharts24KeepBubbleChartDataEntry")
@interface KeepBubbleChartDataEntry : KeepChartDataEntry
...
SWIFT_PROTOCOL("_TtP10KeepCharts27KeepBubbleChartDataProvider_")
@protocol KeepBubbleChartDataProvider <KeepBarLineScatterCandleBubbleChartDataProvider>
@property (nonatomic, readonly, strong) KeepBubbleChartData * _Nullable bubbleData;
@end


SWIFT_PROTOCOL("_TtP10KeepCharts23KeepIBubbleChartDataSet_")
@protocol KeepIBubbleChartDataSet <KeepIBarLineScatterCandleBubbleChartDataSet>
...
SWIFT_CLASS("_TtC10KeepCharts22KeepBubbleChartDataSet")
@interface KeepBubbleChartDataSet : KeepBarLineScatterCandleBubbleChartDataSet <KeepIBubbleChartDataSet>
@property (nonatomic, readonly) CGFloat maxSize;
...
SWIFT_CLASS("_TtC10KeepCharts23KeepBubbleChartRenderer")
@interface KeepBubbleChartRenderer : KeepBarLineScatterCandleBubbleChartRenderer
@property (nonatomic, weak) id <KeepBubbleChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <KeepBubbleChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIBubbleChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<KeepChartHighlight *> * _Nonnull)indices;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts19KeepBubbleChartView")
@interface KeepBubbleChartView : KeepBarLineChartViewBase <KeepBubbleChartDataProvider>
@property (nonatomic, readonly, strong) KeepBubbleChartData * _Nullable bubbleData;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts19KeepCandleChartData")
@interface KeepCandleChartData : KeepBarLineScatterCandleBubbleChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts24KeepCandleChartDataEntry")
@interface KeepCandleChartDataEntry : KeepChartDataEntry
/// shadow-high value
...
SWIFT_PROTOCOL("_TtP10KeepCharts27KeepCandleChartDataProvider_")
@protocol KeepCandleChartDataProvider <KeepBarLineScatterCandleBubbleChartDataProvider>
@property (nonatomic, readonly, strong) KeepCandleChartData * _Nullable candleData;
@end


SWIFT_PROTOCOL("_TtP10KeepCharts39KeepILineScatterCandleRadarChartDataSet_")
@protocol KeepILineScatterCandleRadarChartDataSet <KeepIBarLineScatterCandleBubbleChartDataSet>
...
SWIFT_PROTOCOL("_TtP10KeepCharts23KeepICandleChartDataSet_")
@protocol KeepICandleChartDataSet <KeepILineScatterCandleRadarChartDataSet>
...
SWIFT_CLASS("_TtC10KeepCharts38KeepLineScatterCandleRadarChartDataSet")
@interface KeepLineScatterCandleRadarChartDataSet : KeepBarLineScatterCandleBubbleChartDataSet <KeepILineScatterCandleRadarChartDataSet>
/// Enables / disables the horizontal highlight-indicator. If disabled, the indicator is not drawn.
@property (nonatomic) BOOL drawHorizontalHighlightIndicatorEnabled;
/// Enables / disables the vertical highlight-indicator. If disabled, the indicator is not drawn.
@property (nonatomic) BOOL drawVerticalHighlightIndicatorEnabled;
...
SWIFT_CLASS("_TtC10KeepCharts22KeepCandleChartDataSet")
@interface KeepCandleChartDataSet : KeepLineScatterCandleRadarChartDataSet <KeepICandleChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (void)calcMinMaxYWithEntry:(KeepChartDataEntry * _Nonnull)e;
/// the space that is left out on the left and right side of each candle,
...
SWIFT_CLASS_NAMED("KeepLineScatterCandleRadarRenderer")
@interface KeepLineScatterCandleRadarChartRenderer : KeepBarLineScatterCandleBubbleChartRenderer
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
...
/// :param: horizontal
/// :param: vertical
- (void)drawHighlightLinesWithContext:(CGContextRef _Nonnull)context point:(CGPoint)point set:(id <KeepILineScatterCandleRadarChartDataSet> _Nonnull)set;
@end


SWIFT_CLASS("_TtC10KeepCharts28KeepCandleStickChartRenderer")
@interface KeepCandleStickChartRenderer : KeepLineScatterCandleRadarChartRenderer
@property (nonatomic, weak) id <KeepCandleChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <KeepCandleChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepICandleChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<KeepChartHighlight *> * _Nonnull)indices;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts24KeepCandleStickChartView")
@interface KeepCandleStickChartView : KeepBarLineChartViewBase <KeepCandleChartDataProvider>
@property (nonatomic, readonly, strong) KeepCandleChartData * _Nullable candleData;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts23KeepChartColorTemplates")
@interface KeepChartColorTemplates : NSObject
...
@interface KeepChartDataEntry (SWIFT_EXTENSION(KeepCharts))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end



@interface KeepChartDataEntryBase (SWIFT_EXTENSION(KeepCharts))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end
...
typedef SWIFT_ENUM(NSInteger, KeepChartDataSetRounding) {
  KeepChartDataSetRoundingUp = 0,
  KeepChartDataSetRoundingDown = 1,
  KeepChartDataSetRoundingClosest = 2,
};

typedef SWIFT_ENUM(NSInteger, KeepChartEasingOption) {
  KeepChartEasingOptionLinear = 0,
  KeepChartEasingOptionEaseInQuad = 1,
  KeepChartEasingOptionEaseOutQuad = 2,
  KeepChartEasingOptionEaseInOutQuad = 3,
  KeepChartEasingOptionEaseInCubic = 4,
  KeepChartEasingOptionEaseOutCubic = 5,
  KeepChartEasingOptionEaseInOutCubic = 6,
  KeepChartEasingOptionEaseInQuart = 7,
  KeepChartEasingOptionEaseOutQuart = 8,
  KeepChartEasingOptionEaseInOutQuart = 9,
  KeepChartEasingOptionEaseInQuint = 10,
  KeepChartEasingOptionEaseOutQuint = 11,
  KeepChartEasingOptionEaseInOutQuint = 12,
  KeepChartEasingOptionEaseInSine = 13,
  KeepChartEasingOptionEaseOutSine = 14,
  KeepChartEasingOptionEaseInOutSine = 15,
  KeepChartEasingOptionEaseInExpo = 16,
  KeepChartEasingOptionEaseOutExpo = 17,
  KeepChartEasingOptionEaseInOutExpo = 18,
  KeepChartEasingOptionEaseInCirc = 19,
  KeepChartEasingOptionEaseOutCirc = 20,
  KeepChartEasingOptionEaseInOutCirc = 21,
  KeepChartEasingOptionEaseInElastic = 22,
  KeepChartEasingOptionEaseOutElastic = 23,
  KeepChartEasingOptionEaseInOutElastic = 24,
  KeepChartEasingOptionEaseInBack = 25,
  KeepChartEasingOptionEaseOutBack = 26,
  KeepChartEasingOptionEaseInOutBack = 27,
  KeepChartEasingOptionEaseInBounce = 28,
  KeepChartEasingOptionEaseOutBounce = 29,
  KeepChartEasingOptionEaseInOutBounce = 30,
};


enum KeepChartLimitLabelPosition : NSInteger;

/// The limit line is an additional feature for all Line, Bar and ScatterCharts.
/// It allows the displaying of an additional line in the chart that marks a certain maximum / limit on the specified axis (x- or y-axis).
SWIFT_CLASS("_TtC10KeepCharts18KeepChartLimitLine")
@interface KeepChartLimitLine : KeepChartComponentBase
...
@property (nonatomic) enum KeepChartLimitLabelPosition labelPosition;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLimitLabelPosition, "LabelPosition") {
  KeepChartLimitLabelPositionLeftTop = 0,
  KeepChartLimitLabelPositionLeftBottom = 1,
  KeepChartLimitLabelPositionRightTop = 2,
  KeepChartLimitLabelPositionRightBottom = 3,
};



SWIFT_PROTOCOL("_TtP10KeepCharts21KeepChartViewDelegate_")
@protocol KeepChartViewDelegate
@optional
...
///
- (void)chartValueSelected:(KeepChartViewBase * _Nonnull)chartView entry:(KeepChartDataEntry * _Nonnull)entry highlight:(KeepChartHighlight * _Nonnull)highlight;
- (void)chartValueLongPressed:(KeepChartViewBase * _Nonnull)chartView entry:(KeepChartDataEntry * _Nonnull)entry dataSetIndex:(NSInteger)dataSetIndex highlight:(KeepChartHighlight * _Nonnull)highlight;
...
SWIFT_PROTOCOL("_TtP10KeepCharts18KeepIShapeRenderer_")
@protocol KeepIShapeRenderer
...
///
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
@end


SWIFT_CLASS("_TtC10KeepCharts28KeepChevronDownShapeRenderer")
@interface KeepChevronDownShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts26KeepChevronUpShapeRenderer")
@interface KeepChevronUpShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts23KeepCircleShapeRenderer")
@interface KeepCircleShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class KeepLineChartData;
@class KeepScatterChartData;

SWIFT_CLASS("_TtC10KeepCharts21KeepCombinedChartData")
@interface KeepCombinedChartData : KeepBarLineScatterCandleBubbleChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) KeepLineChartData * _Null_unspecified lineData;
@property (nonatomic, strong) KeepBarChartData * _Null_unspecified barData;
@property (nonatomic, strong) KeepScatterChartData * _Null_unspecified scatterData;
@property (nonatomic, strong) KeepCandleChartData * _Null_unspecified candleData;
@property (nonatomic, strong) KeepBubbleChartData * _Null_unspecified bubbleData;
- (void)calcMinMax;
///
/// returns:
/// All data objects in row: line-bar-scatter-candle-bubble if not null.
@property (nonatomic, readonly, copy) NSArray<KeepChartData *> * _Nonnull allData;
- (KeepChartData * _Nonnull)dataByIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (BOOL)removeDataSet:(id <KeepIChartDataSet> _Null_unspecified)dataSet SWIFT_WARN_UNUSED_RESULT;
- (BOOL)removeDataSetByIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (BOOL)removeEntry:(KeepChartDataEntry * _Nonnull)entry dataSetIndex:(NSInteger)dataSetIndex SWIFT_WARN_UNUSED_RESULT;
...
- (id <KeepIChartDataSet> _Null_unspecified)getDataSetByHighlight:(KeepChartHighlight * _Nonnull)highlight SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP10KeepCharts28KeepScatterChartDataProvider_")
@protocol KeepScatterChartDataProvider <KeepBarLineScatterCandleBubbleChartDataProvider>
@property (nonatomic, readonly, strong) KeepScatterChartData * _Nullable scatterData;
@end
...
SWIFT_PROTOCOL("_TtP10KeepCharts29KeepCombinedChartDataProvider_")
@protocol KeepCombinedChartDataProvider <KeepBarChartDataProvider, KeepBubbleChartDataProvider, KeepCandleChartDataProvider, KeepLineChartDataProvider, KeepScatterChartDataProvider>
@property (nonatomic, readonly, strong) KeepCombinedChartData * _Nullable combinedData;
@end

@class KeepCombinedChartView;

SWIFT_CLASS("_TtC10KeepCharts25KeepCombinedChartRenderer")
@interface KeepCombinedChartRenderer : KeepChartDataRendererBase
@property (nonatomic, weak) KeepCombinedChartView * _Nullable chart;
...
- (KeepChartDataRendererBase * _Nullable)getSubRendererWithIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// All sub-renderers.
@property (nonatomic, copy) NSArray<KeepChartDataRendererBase *> * _Nonnull subRenderers;
///
/// returns:
...
@protocol KeepIChartFillFormatter;

/// This chart class allows the combination of lines, bars, scatter and candle data all displayed in one chart area.
SWIFT_CLASS("_TtC10KeepCharts21KeepCombinedChartView")
@interface KeepCombinedChartView : KeepBarLineChartViewBase <KeepCombinedChartDataProvider>
@property (nonatomic, strong) KeepChartData * _Nullable data;
@property (nonatomic, strong) id <KeepIChartFillFormatter> _Nonnull fillFormatter;
///
/// returns:
/// The KeepHighlight object (contains x-index and DataSet index) of the selected value at the given touch point inside the CombinedChart.
- (KeepChartHighlight * _Nullable)getHighlightByTouchPoint:(CGPoint)pt SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, strong) KeepCombinedChartData * _Nullable combinedData;
@property (nonatomic, readonly, strong) KeepLineChartData * _Nullable lineData;
@property (nonatomic, readonly, strong) KeepBarChartData * _Nullable barData;
...
SWIFT_CLASS_NAMED("KeepCombinedHighlighter")
@interface KeepCombinedChartHighlighter : KeepChartHighlighter
- (nonnull instancetype)initWithChart:(id <KeepCombinedChartDataProvider> _Nonnull)chart barDataProvider:(id <KeepBarChartDataProvider> _Nonnull)barDataProvider OBJC_DESIGNATED_INITIALIZER;
- (NSArray<KeepChartHighlight *> * _Nonnull)getHighlightsWithXValue:(double)xValue x:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <KeepChartDataProvider> _Nonnull)chart SWIFT_UNAVAILABLE;
@end



SWIFT_CLASS("_TtC10KeepCharts22KeepCrossShapeRenderer")
@interface KeepCrossShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("KeepDataApproximator")
@interface KeepChartDataApproximator : NSObject
...
@interface KeepChartDataApproximator (SWIFT_EXTENSION(KeepCharts))
...
SWIFT_CLASS_NAMED("KeepDefaultAxisValueFormatter")
@interface KeepChartDefaultAxisValueFormatter : NSObject <KeepIChartAxisValueFormatter>
@property (nonatomic, copy) NSString * _Nonnull (^ _Nullable block)(double, KeepChartAxisBase * _Nullable);
...
- (nonnull instancetype)initWithBlock:(NSString * _Nonnull (^ _Nonnull)(double, KeepChartAxisBase * _Nullable))block OBJC_DESIGNATED_INITIALIZER;
+ (KeepChartDefaultAxisValueFormatter * _Nullable)withBlock:(NSString * _Nonnull (^ _Nonnull)(double, KeepChartAxisBase * _Nullable))block SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)stringForValue:(double)value axis:(KeepChartAxisBase * _Nullable)axis SWIFT_WARN_UNUSED_RESULT;
@end

@protocol KeepILineChartDataSet;
...
SWIFT_PROTOCOL_NAMED("KeepIFillFormatter")
@protocol KeepIChartFillFormatter
///
/// returns:
/// The vertical (y-axis) position where the filled-line of the LineDataSet should end.
- (CGFloat)getFillLinePositionWithDataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet dataProvider:(id <KeepLineChartDataProvider> _Nonnull)dataProvider SWIFT_WARN_UNUSED_RESULT;
@end


/// Default formatter that calculates the position of the filled line.
SWIFT_CLASS_NAMED("KeepDefaultFillFormatter")
@interface KeepChartDefaultFillFormatter : NSObject <KeepIChartFillFormatter>
@property (nonatomic, copy) CGFloat (^ _Nullable block)(id <KeepILineChartDataSet> _Nonnull, id <KeepLineChartDataProvider> _Nonnull);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBlock:(CGFloat (^ _Nonnull)(id <KeepILineChartDataSet> _Nonnull, id <KeepLineChartDataProvider> _Nonnull))block OBJC_DESIGNATED_INITIALIZER;
+ (KeepChartDefaultFillFormatter * _Nullable)withBlock:(CGFloat (^ _Nonnull)(id <KeepILineChartDataSet> _Nonnull, id <KeepLineChartDataProvider> _Nonnull))block SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)getFillLinePositionWithDataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet dataProvider:(id <KeepLineChartDataProvider> _Nonnull)dataProvider SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_PROTOCOL_NAMED("KeepIValueFormatter")
@protocol KeepIChartValueFormatter
...
- (NSString * _Nonnull)stringForValue:(double)value entry:(KeepChartDataEntry * _Nonnull)entry dataSetIndex:(NSInteger)dataSetIndex viewPortHandler:(KeepChartViewPortHandler * _Nullable)viewPortHandler SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS_NAMED("KeepDefaultValueFormatter")
@interface KeepChartDefaultValueFormatter : NSObject <KeepIChartValueFormatter>
@property (nonatomic, copy) NSString * _Nonnull (^ _Nullable block)(double, KeepChartDataEntry * _Nonnull, NSInteger, KeepChartViewPortHandler * _Nullable);
@property (nonatomic) BOOL hasAutoDecimals;
@property (nonatomic, strong) NSNumberFormatter * _Nullable formatter;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFormatter:(NSNumberFormatter * _Nonnull)formatter OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDecimals:(NSInteger)decimals OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBlock:(NSString * _Nonnull (^ _Nonnull)(double, KeepChartDataEntry * _Nonnull, NSInteger, KeepChartViewPortHandler * _Nullable))block OBJC_DESIGNATED_INITIALIZER;
+ (KeepChartDefaultValueFormatter * _Nullable)withBlock:(NSString * _Nonnull (^ _Nonnull)(double, KeepChartDataEntry * _Nonnull, NSInteger, KeepChartViewPortHandler * _Nullable))block SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)stringForValue:(double)value entry:(KeepChartDataEntry * _Nonnull)entry dataSetIndex:(NSInteger)dataSetIndex viewPortHandler:(KeepChartViewPortHandler * _Nullable)viewPortHandler SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS_NAMED("KeepDescription")
@interface KeepChartDescription : KeepChartComponentBase
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
enum KeepChartFillType : NSInteger;

SWIFT_CLASS_NAMED("KeepFill")
@interface KeepChartFill : NSObject
@property (nonatomic, readonly) enum KeepChartFillType type;
...
+ (KeepChartFill * _Nonnull)fillWithCGColor:(CGColorRef _Nonnull)CGColor SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithColor:(UIColor * _Nonnull)color SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithLinearGradient:(CGGradientRef _Nonnull)linearGradient angle:(CGFloat)angle SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithRadialGradient:(CGGradientRef _Nonnull)radialGradient startOffsetPercent:(CGPoint)startOffsetPercent startRadiusPercent:(CGFloat)startRadiusPercent endOffsetPercent:(CGPoint)endOffsetPercent endRadiusPercent:(CGFloat)endRadiusPercent SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithRadialGradient:(CGGradientRef _Nonnull)radialGradient SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithCGImage:(CGImageRef _Nonnull)CGImage tiled:(BOOL)tiled SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithImage:(UIImage * _Nonnull)image tiled:(BOOL)tiled SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithCGImage:(CGImageRef _Nonnull)CGImage SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithImage:(UIImage * _Nonnull)image SWIFT_WARN_UNUSED_RESULT;
+ (KeepChartFill * _Nonnull)fillWithCGLayer:(CGLayerRef _Nonnull)CGLayer SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartFillType, "KeepFillType") {
  KeepChartFillTypeEmpty = 0,
  KeepChartFillTypeColor = 1,
  KeepChartFillTypeLinearGradient = 2,
  KeepChartFillTypeRadialGradient = 3,
  KeepChartFillTypeImage = 4,
  KeepChartFillTypeTiledImage = 5,
  KeepChartFillTypeLayer = 6,
};


SWIFT_CLASS_NAMED("KeepHighlight")
@interface KeepChartHighlight : NSObject
...
@interface KeepChartHighlight (SWIFT_EXTENSION(KeepCharts))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC10KeepCharts30KeepHorizontalBarChartRenderer")
@interface KeepHorizontalBarChartRenderer : KeepBarChartRenderer
- (nonnull instancetype)initWithDataProvider:(id <KeepBarChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)initBuffers SWIFT_METHOD_FAMILY(none);
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIBarChartDataSet> _Nonnull)dataSet index:(NSInteger)index;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
...
SWIFT_CLASS_NAMED("KeepHorizontalBarHighlighter")
@interface KeepHorizontalBarChartHighlighter : KeepBarChartHighlighter
- (KeepChartHighlight * _Nullable)getHighlightWithX:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <KeepChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_PROTOCOL("_TtP10KeepCharts26KeepILineRadarChartDataSet_")
@protocol KeepILineRadarChartDataSet <KeepILineScatterCandleRadarChartDataSet>
...
/// <em>default</em>: nil
@property (nonatomic, strong) KeepChartFill * _Nullable fill;
...
enum KeepLineChartMode : NSInteger;

SWIFT_PROTOCOL("_TtP10KeepCharts21KeepILineChartDataSet_")
@protocol KeepILineChartDataSet <KeepILineRadarChartDataSet>
/// The drawing mode for this line dataset
/// <em>default</em>: Linear
@property (nonatomic) enum KeepLineChartMode mode;
...
@property (nonatomic, strong) id <KeepIChartFillFormatter> _Nullable fillFormatter;
@end




SWIFT_PROTOCOL_NAMED("KeepIMarker")
@protocol KeepIChartMarker
...
///
/// returns:
/// The desired (general) offset you wish the KeepIMarker to have on the x-axis.
...
/// \param entry The Entry the KeepIMarker belongs to. This can also be any subclass of Entry, like BarEntry or CandleEntry, simply cast it at runtime.
///
...
///
- (void)refreshContentWithEntry:(KeepChartDataEntry * _Nonnull)entry highlight:(KeepChartHighlight * _Nonnull)highlight;
...
enum KeepPieChartValuePosition : NSInteger;

SWIFT_PROTOCOL("_TtP10KeepCharts20KeepIPieChartDataSet_")
@protocol KeepIPieChartDataSet <KeepIChartDataSet>
...
@property (nonatomic) enum KeepPieChartValuePosition xValuePosition;
@property (nonatomic) enum KeepPieChartValuePosition yValuePosition;
...
SWIFT_PROTOCOL("_TtP10KeepCharts22KeepIRadarChartDataSet_")
@protocol KeepIRadarChartDataSet <KeepILineRadarChartDataSet>
...
SWIFT_PROTOCOL("_TtP10KeepCharts24KeepIScatterChartDataSet_")
@protocol KeepIScatterChartDataSet <KeepILineScatterCandleRadarChartDataSet>
///
/// returns:
...
@property (nonatomic, readonly, strong) id <KeepIShapeRenderer> _Nullable shapeRenderer;
@end
...
SWIFT_CLASS_NAMED("KeepIndexAxisValueFormatter")
@interface KeepChartIndexAxisValueFormatter : NSObject <KeepIChartAxisValueFormatter>
...
+ (KeepChartIndexAxisValueFormatter * _Nullable)withValues:(NSArray<NSString *> * _Nonnull)values SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)stringForValue:(double)value axis:(KeepChartAxisBase * _Nullable)axis SWIFT_WARN_UNUSED_RESULT;
@end

@class KeepChartLegendEntry;
enum KeepChartLegendHorizontalAlignment : NSInteger;
enum KeepChartLegendVerticalAlignment : NSInteger;
enum KeepChartLegendOrientation : NSInteger;
enum KeepChartLegendDirection : NSInteger;

SWIFT_CLASS_NAMED("KeepLegend")
@interface KeepChartLegend : KeepChartComponentBase
/// The legend entries array
@property (nonatomic, copy) NSArray<KeepChartLegendEntry *> * _Nonnull entries;
/// Entries that will be appended to the end of the auto calculated entries after calculating the legend.
/// (if the legend has already been calculated, you will need to call notifyDataSetChanged() to let the changes take effect)
@property (nonatomic, copy) NSArray<KeepChartLegendEntry *> * _Nonnull extraEntries;
/// The horizontal alignment of the legend
@property (nonatomic) enum KeepChartLegendHorizontalAlignment horizontalAlignment;
/// The vertical alignment of the legend
@property (nonatomic) enum KeepChartLegendVerticalAlignment verticalAlignment;
/// The orientation of the legend
@property (nonatomic) enum KeepChartLegendOrientation orientation;
...
@property (nonatomic) enum KeepChartLegendDirection direction;
@property (nonatomic, strong) UIFont * _Nonnull font;
@property (nonatomic, strong) UIColor * _Nonnull textColor;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithEntries:(NSArray<KeepChartLegendEntry *> * _Nonnull)entries OBJC_DESIGNATED_INITIALIZER;
...
- (void)calculateDimensionsWithLabelFont:(UIFont * _Nonnull)labelFont viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler;
/// MARK: - Custom legend
...
///   </li>
/// </ul>
- (void)setCustomWithEntries:(NSArray<KeepChartLegendEntry *> * _Nonnull)entries;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLegendForm, "Form") {
/// Avoid drawing a form
  KeepChartLegendFormNone = 0,
/// Do not draw the a form, but leave space for it
  KeepChartLegendFormEmpty = 1,
/// Use default (default dataset’s form to the legend’s form)
  KeepChartLegendFormDefault = 2,
/// Draw a square
  KeepChartLegendFormSquare = 3,
/// Draw a circle
  KeepChartLegendFormCircle = 4,
/// Draw a horizontal line
  KeepChartLegendFormLine = 5,
};

typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLegendHorizontalAlignment, "HorizontalAlignment") {
  KeepChartLegendHorizontalAlignmentLeft = 0,
  KeepChartLegendHorizontalAlignmentCenter = 1,
  KeepChartLegendHorizontalAlignmentRight = 2,
};

typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLegendVerticalAlignment, "VerticalAlignment") {
  KeepChartLegendVerticalAlignmentTop = 0,
  KeepChartLegendVerticalAlignmentCenter = 1,
  KeepChartLegendVerticalAlignmentBottom = 2,
};

typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLegendOrientation, "Orientation") {
  KeepChartLegendOrientationHorizontal = 0,
  KeepChartLegendOrientationVertical = 1,
};

typedef SWIFT_ENUM_NAMED(NSInteger, KeepChartLegendDirection, "Direction") {
  KeepChartLegendDirectionLeftToRight = 0,
  KeepChartLegendDirectionRightToLeft = 1,
};


SWIFT_CLASS_NAMED("KeepLegendEntry")
@interface KeepChartLegendEntry : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
///
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label form:(enum KeepChartLegendForm)form formSize:(CGFloat)formSize formLineWidth:(CGFloat)formLineWidth formLineDashPhase:(CGFloat)formLineDashPhase formLineDashLengths:(NSArray<NSNumber *> * _Nullable)formLineDashLengths formColor:(UIColor * _Nullable)formColor OBJC_DESIGNATED_INITIALIZER;
...
/// <code>Default</code> will use the KeepLegend’s default.
@property (nonatomic) enum KeepChartLegendForm form;
...
SWIFT_CLASS_NAMED("KeepLegendRenderer")
@interface KeepChartLegendRenderer : KeepChartRenderer
/// the legend object this renderer renders
@property (nonatomic, strong) KeepChartLegend * _Nullable legend;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler legend:(KeepChartLegend * _Nullable)legend OBJC_DESIGNATED_INITIALIZER;
/// Prepares the legend and calculates all needed forms, labels and colors.
- (void)computeLegendWithData:(KeepChartData * _Nonnull)data;
...
- (void)drawFormWithContext:(CGContextRef _Nonnull)context x:(CGFloat)x y:(CGFloat)y entry:(KeepChartLegendEntry * _Nonnull)entry legend:(KeepChartLegend * _Nonnull)legend;
...
SWIFT_CLASS("_TtC10KeepCharts17KeepLineChartData")
@interface KeepLineChartData : KeepChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts25KeepLineRadarChartDataSet")
@interface KeepLineRadarChartDataSet : KeepLineScatterCandleRadarChartDataSet <KeepILineRadarChartDataSet>
/// The color that is used for filling the line surface area.
@property (nonatomic, strong) UIColor * _Nonnull fillColor;
/// The object that is used for filling the area below the line.
/// <em>default</em>: nil
...
SWIFT_CLASS("_TtC10KeepCharts20KeepLineChartDataSet")
@interface KeepLineChartDataSet : KeepLineRadarChartDataSet <KeepILineChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
/// The drawing mode for this line dataset
/// <em>default</em>: Linear
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepLineChartMode, "Mode") {
  KeepLineChartModeLinear = 0,
  KeepLineChartModeStepped = 1,
  KeepLineChartModeCubicBezier = 2,
  KeepLineChartModeHorizontalBezier = 3,
};


SWIFT_CLASS_NAMED("KeepLineRadarRenderer")
@interface KeepLineRadarChartRenderer : KeepLineScatterCandleRadarChartRenderer
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
/// Draws the provided path in filled mode with the provided drawable.
- (void)drawFilledPathWithContext:(CGContextRef _Nonnull)context path:(CGPathRef _Nonnull)path fill:(KeepChartFill * _Nonnull)fill fillAlpha:(CGFloat)fillAlpha;
...
SWIFT_CLASS("_TtC10KeepCharts21KeepLineChartRenderer")
@interface KeepLineChartRenderer : KeepLineRadarChartRenderer
@property (nonatomic, weak) id <KeepLineChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <KeepLineChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet;
- (void)drawCubicBezierWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet;
- (void)drawHorizontalBezierWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet;
- (void)drawLinearWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepILineChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<KeepChartHighlight *> * _Nonnull)indices;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts17KeepLineChartView")
@interface KeepLineChartView : KeepBarLineChartViewBase <KeepLineChartDataProvider>
@property (nonatomic, readonly, strong) KeepLineChartData * _Nullable lineData;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("KeepMarkerImage")
@interface KeepChartMarkerImage : NSObject <KeepIChartMarker>
/// The marker image to render
@property (nonatomic, strong) UIImage * _Nullable image;
@property (nonatomic) CGPoint offset;
@property (nonatomic, weak) KeepChartViewBase * _Nullable chartView;
...
SWIFT_CLASS_NAMED("KeepMarkerView")
@interface KeepChartMarkerView : NSUIView <KeepIChartMarker>
@property (nonatomic) CGPoint offset;
@property (nonatomic, weak) KeepChartViewBase * _Nullable chartView;
- (CGPoint)offsetForDrawingAtPoint:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
- (void)refreshContentWithEntry:(KeepChartDataEntry * _Nonnull)entry highlight:(KeepChartHighlight * _Nonnull)highlight;
- (void)drawWithContext:(CGContextRef _Nonnull)context point:(CGPoint)point;
+ (KeepChartMarkerView * _Nullable)viewFromXibIn:(NSBundle * _Nonnull)bundle SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("KeepMoveViewJob")
@interface KeepMoveChartViewJob : KeepChartViewPortJob
- (void)doJob;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xValue:(double)xValue yValue:(double)yValue transformer:(KeepChartTransformer * _Nonnull)transformer view:(KeepChartViewBase * _Nonnull)view OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10KeepCharts16KeepPieChartData")
@interface KeepPieChartData : KeepChartData
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithDataSets:(NSArray<id <KeepIChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
///
/// returns:
/// All DataSet objects this KeepChartData object holds.
@property (nonatomic, copy) NSArray<id <KeepIChartDataSet>> * _Nonnull dataSets;
- (id <KeepIChartDataSet> _Nullable)getDataSetByIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (id <KeepIChartDataSet> _Nullable)getDataSetByLabel:(NSString * _Nonnull)label ignorecase:(BOOL)ignorecase SWIFT_WARN_UNUSED_RESULT;
- (KeepChartDataEntry * _Nullable)entryForHighlight:(KeepChartHighlight * _Nonnull)highlight SWIFT_WARN_UNUSED_RESULT;
- (void)addDataSet:(id <KeepIChartDataSet> _Null_unspecified)d;
/// Removes the DataSet at the given index in the DataSet array from the data object.
/// Also recalculates all minimum and maximum values.
///
/// returns:
...
SWIFT_CLASS("_TtC10KeepCharts21KeepPieChartDataEntry")
@interface KeepPieChartDataEntry : KeepChartDataEntry
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10KeepCharts19KeepPieChartDataSet")
@interface KeepPieChartDataSet : KeepChartDataSet <KeepIPieChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
/// the space in pixels between the pie-slices
/// <em>default</em>: 0
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepPieChartValuePosition, "ValuePosition") {
  KeepPieChartValuePositionInsideSlice = 0,
  KeepPieChartValuePositionOutsideSlice = 1,
};

@class KeepPieChartView;

SWIFT_CLASS("_TtC10KeepCharts20KeepPieChartRenderer")
@interface KeepPieChartRenderer : KeepChartDataRendererBase
@property (nonatomic, weak) KeepPieChartView * _Nullable chart;
- (nonnull instancetype)initWithChart:(KeepPieChartView * _Nonnull)chart animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
- (CGFloat)getSliceSpaceWithDataSet:(id <KeepIPieChartDataSet> _Nonnull)dataSet SWIFT_WARN_UNUSED_RESULT;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIPieChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<KeepChartHighlight *> * _Nonnull)indices;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts25KeepPieRadarChartViewBase")
@interface KeepPieRadarChartViewBase : KeepChartViewBase
...
- (void)spinWithDuration:(NSTimeInterval)duration fromAngle:(CGFloat)fromAngle toAngle:(CGFloat)toAngle easingOption:(enum KeepChartEasingOption)easingOption;
...
SWIFT_CLASS("_TtC10KeepCharts16KeepPieChartView")
@interface KeepPieChartView : KeepPieRadarChartViewBase
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(CGRect)rect;
- (CGPoint)getMarkerPositionWithHighlight:(KeepChartHighlight * _Nonnull)highlight SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_NAMED("KeepPieRadarHighlighter")
@interface KeepPieRadarChartHighlighter : KeepChartHighlighter
- (KeepChartHighlight * _Nullable)getHighlightWithX:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
/// \param index 
///
/// \param x 
...
///
/// returns:
/// The closest KeepHighlight object of the given objects based on the touch position inside the chart.
- (KeepChartHighlight * _Nullable)closestHighlightWithIndex:(NSInteger)index x:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <KeepChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("KeepPieHighlighter")
@interface KeepPieChartHighlighter : KeepPieRadarChartHighlighter
- (KeepChartHighlight * _Nullable)closestHighlightWithIndex:(NSInteger)index x:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <KeepChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts18KeepRadarChartData")
@interface KeepRadarChartData : KeepChartData
@property (nonatomic, strong) UIColor * _Nonnull highlightColor;
@property (nonatomic) CGFloat highlightLineWidth;
@property (nonatomic) CGFloat highlightLineDashPhase;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable highlightLineDashLengths;
...
SWIFT_CLASS("_TtC10KeepCharts23KeepRadarChartDataEntry")
@interface KeepRadarChartDataEntry : KeepChartDataEntry
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// \param value The value on the y-axis.
///
/// \param data Spot for additional data this Entry represents.
...
SWIFT_CLASS("_TtC10KeepCharts21KeepRadarChartDataSet")
@interface KeepRadarChartDataSet : KeepLineRadarChartDataSet <KeepIRadarChartDataSet>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
/// flag indicating whether highlight circle should be drawn or not
/// <em>default</em>: false
...
@class KeepRadarChartView;

SWIFT_CLASS("_TtC10KeepCharts22KeepRadarChartRenderer")
@interface KeepRadarChartRenderer : KeepLineRadarChartRenderer
@property (nonatomic, weak) KeepRadarChartView * _Nullable chart;
- (nonnull instancetype)initWithChart:(KeepRadarChartView * _Nonnull)chart animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
...
SWIFT_CLASS("_TtC10KeepCharts18KeepRadarChartView")
@interface KeepRadarChartView : KeepPieRadarChartViewBase
...
@property (nonatomic, readonly, strong) KeepChartYAxis * _Nonnull yAxis;
...
SWIFT_CLASS_NAMED("KeepRadarHighlighter")
@interface KeepRadarChartHighlighter : KeepPieRadarChartHighlighter
- (KeepChartHighlight * _Nullable)closestHighlightWithIndex:(NSInteger)index x:(CGFloat)x y:(CGFloat)y SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <KeepChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("KeepRange")
@interface KeepChartRange : NSObject
...
enum KeepScatterShape : NSInteger;

SWIFT_CLASS("_TtC10KeepCharts23KeepScatterChartDataSet")
@interface KeepScatterChartDataSet : KeepLineScatterCandleRadarChartDataSet <KeepIScatterChartDataSet>
/// The size the scatter shape will have
...
- (void)setScatterShape:(enum KeepScatterShape)shape;
/// The KeepIShapeRenderer responsible for rendering this DataSet.
...
@property (nonatomic, strong) id <KeepIShapeRenderer> _Nullable shapeRenderer;
+ (id <KeepIShapeRenderer> _Nonnull)rendererForShape:(enum KeepScatterShape)shape SWIFT_WARN_UNUSED_RESULT;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<KeepChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepScatterShape, "Shape") {
  KeepScatterShapeSquare = 0,
  KeepScatterShapeCircle = 1,
  KeepScatterShapeTriangle = 2,
  KeepScatterShapeCross = 3,
  KeepScatterShapeX = 4,
  KeepScatterShapeChevronUp = 5,
  KeepScatterShapeChevronDown = 6,
};


SWIFT_CLASS("_TtC10KeepCharts24KeepScatterChartRenderer")
@interface KeepScatterChartRenderer : KeepLineScatterCandleRadarChartRenderer
@property (nonatomic, weak) id <KeepScatterChartDataProvider> _Nullable dataProvider;
- (nonnull instancetype)initWithDataProvider:(id <KeepScatterChartDataProvider> _Nonnull)dataProvider animator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<KeepChartHighlight *> * _Nonnull)indices;
- (nonnull instancetype)initWithAnimator:(KeepChartAnimator * _Nonnull)animator viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts20KeepScatterChartView")
@interface KeepScatterChartView : KeepBarLineChartViewBase <KeepScatterChartDataProvider>
@property (nonatomic, readonly, strong) KeepScatterChartData * _Nullable scatterData;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts23KeepSquareShapeRenderer")
@interface KeepSquareShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("KeepTransformer")
@interface KeepChartTransformer : NSObject
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("KeepTransformerHorizontalBarChart")
@interface KeepChartTransformerHorizontalBarChart : KeepChartTransformer
/// Prepares the matrix that contains all offsets.
- (void)prepareMatrixOffsetWithInverted:(BOOL)inverted;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10KeepCharts25KeepTriangleShapeRenderer")
@interface KeepTriangleShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("KeepViewPortHandler")
@interface KeepChartViewPortHandler : NSObject
...
- (void)centerViewPortWithPt:(CGPoint)pt chart:(KeepChartViewBase * _Nonnull)chart;
/// call this method to refresh the graph with a given matrix
- (CGAffineTransform)refreshWithNewMatrix:(CGAffineTransform)newMatrix chart:(KeepChartViewBase * _Nonnull)chart invalidate:(BOOL)invalidate;
...
@property (nonatomic) enum KeepXAxisLabelPosition labelPosition;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepXAxisLabelPosition, "LabelPosition") {
  KeepXAxisLabelPositionTop = 0,
  KeepXAxisLabelPositionBottom = 1,
  KeepXAxisLabelPositionBothSided = 2,
  KeepXAxisLabelPositionTopInside = 3,
  KeepXAxisLabelPositionBottomInside = 4,
};


SWIFT_CLASS_NAMED("KeepXAxisRenderer")
@interface KeepChartXAxisRenderer : KeepChartAxisRendererBase
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xAxis:(KeepChartXAxis * _Nullable)xAxis transformer:(KeepChartTransformer * _Nullable)transformer OBJC_DESIGNATED_INITIALIZER;
- (void)computeAxisWithMin:(double)min max:(double)max inverted:(BOOL)inverted;
- (void)computeAxisValuesWithMin:(double)min max:(double)max;
- (void)computeSize;
- (void)renderAxisLabelsWithContext:(CGContextRef _Nonnull)context;
...
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (void)renderLimitLineLineWithContext:(CGContextRef _Nonnull)context limitLine:(KeepChartLimitLine * _Nonnull)limitLine position:(CGPoint)position;
- (void)renderLimitLineLabelWithContext:(CGContextRef _Nonnull)context limitLine:(KeepChartLimitLine * _Nonnull)limitLine position:(CGPoint)position yOffset:(CGFloat)yOffset;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler transformer:(KeepChartTransformer * _Nullable)transformer axis:(KeepChartAxisBase * _Nullable)axis SWIFT_UNAVAILABLE;
@end
...
- (void)renderAxisLineWithContext:(CGContextRef _Nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xAxis:(KeepChartXAxis * _Nullable)xAxis transformer:(KeepChartTransformer * _Nullable)transformer SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC10KeepCharts27KeepXAxisRendererRadarChart")
@interface KeepXAxisRendererRadarChart : KeepChartXAxisRenderer
@property (nonatomic, weak) KeepRadarChartView * _Nullable chart;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xAxis:(KeepChartXAxis * _Nullable)xAxis chart:(KeepRadarChartView * _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
- (void)renderAxisLabelsWithContext:(CGContextRef _Nonnull)context;
- (void)drawLabelWithContext:(CGContextRef _Nonnull)context formattedLabel:(NSString * _Nonnull)formattedLabel x:(CGFloat)x y:(CGFloat)y attributes:(NSDictionary<NSAttributedStringKey, id> * _Nonnull)attributes anchor:(CGPoint)anchor angleRadians:(CGFloat)angleRadians;
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler xAxis:(KeepChartXAxis * _Nullable)xAxis transformer:(KeepChartTransformer * _Nullable)transformer SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC10KeepCharts18KeepXShapeRenderer")
@interface KeepXShapeRenderer : NSObject <KeepIShapeRenderer>
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <KeepIScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(UIColor * _Nonnull)color;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

enum KeepYAxisLabelPosition : NSInteger;

/// Class representing the y-axis labels settings and its entries.
/// Be aware that not all features the YLabels class provides are suitable for the RadarChart.
/// Customizations that affect the value range of the axis need to be applied before setting data for the chart.
SWIFT_CLASS_NAMED("KeepYAxis")
@interface KeepChartYAxis : KeepChartAxisBase
...
@property (nonatomic) enum KeepYAxisLabelPosition labelPosition;
...
typedef SWIFT_ENUM_NAMED(NSInteger, KeepYAxisLabelPosition, "LabelPosition") {
  KeepYAxisLabelPositionOutsideChart = 0,
  KeepYAxisLabelPositionInsideChart = 1,
};
...
SWIFT_CLASS_NAMED("KeepYAxisRenderer")
@interface KeepChartYAxisRenderer : KeepChartAxisRendererBase
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler yAxis:(KeepChartYAxis * _Nullable)yAxis transformer:(KeepChartTransformer * _Nullable)transformer OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10KeepCharts35KeepYAxisRendererHorizontalBarChart")
@interface KeepYAxisRendererHorizontalBarChart : KeepChartYAxisRenderer
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler yAxis:(KeepChartYAxis * _Nullable)yAxis transformer:(KeepChartTransformer * _Nullable)transformer OBJC_DESIGNATED_INITIALIZER;
/// Computes the axis values.
- (void)computeAxisWithMin:(double)min max:(double)max inverted:(BOOL)inverted;
/// draws the y-axis labels to the screen
...
SWIFT_CLASS("_TtC10KeepCharts27KeepYAxisRendererRadarChart")
@interface KeepYAxisRendererRadarChart : KeepChartYAxisRenderer
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler yAxis:(KeepChartYAxis * _Nullable)yAxis chart:(KeepRadarChartView * _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
- (void)computeAxisValuesWithMin:(double)yMin max:(double)yMax;
- (void)renderAxisLabelsWithContext:(CGContextRef _Nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (nonnull instancetype)initWithViewPortHandler:(KeepChartViewPortHandler * _Nonnull)viewPortHandler yAxis:(KeepChartYAxis * _Nullable)yAxis transformer:(KeepChartTransformer * _Nullable)transformer SWIFT_UNAVAILABLE;
@end
